...
while cap.isOpened():
    ...
    # Применение метода вычитания фона к текущему кадру
    fg_mask = background_subtractor.apply(frame)

    # Применение порога для определения областей движения
    threshold = 50
    ...
    # Отображение контуров объектов
    for contour in contours:
        if cv2.contourArea(contour) > 100:  # Минимальная площадь объекта для отображения
