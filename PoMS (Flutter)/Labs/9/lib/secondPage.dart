    ...
    return BlocProvider(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          leading: InkWell(
            onTap: () {
              BlocProvider.of<SecondPageBloc>(context).add(BackButtonPressedEvent());
            },
            child: Row(
              children: [
                Container(
        ...
        body: SingleChildScrollView(
          child: Column(
            children: [
              BlocBuilder<SecondPageBloc, SecondPageState>(
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    const Text(
                      "The best spring holiday in Warsaw",
